<template>
	<view class="index">
		<musichead title="音乐盒子" :icon="false"></musichead>
...
<style scoped>
	...
	.index-list-text{font-size: 24rpx;line-height: 66rpx;flex: 1;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;}
</style>
